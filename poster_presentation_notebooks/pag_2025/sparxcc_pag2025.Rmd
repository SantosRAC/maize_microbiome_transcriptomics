...
```{r}
# Day samples
wallace_otu_counts_filtered_day <- read.csv("C:/Users/renat/Downloads/tmp/SparXCC_pag2025/otu_table_sample_filtered_day_otu_filtered.tsv", sep="\t", header=TRUE, row.names=1)
...
# Night samples
wallace_otu_counts_filtered_night <- read.csv("C:/Users/renat/Downloads/tmp/SparXCC_pag2025/otu_table_sample_filtered_night_otu_filtered.tsv", sep="\t", header=TRUE, row.names=1)
...
kremling_expression_counts_filtered <- read.csv("C:/Users/renat/Downloads/tmp/SparXCC_pag2025/expression_counts_day_night_filtered_cv_filtered.tsv", sep="\t", header=TRUE, row.names=1)

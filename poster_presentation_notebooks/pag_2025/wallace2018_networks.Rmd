 ...
 * `original_otu_counts_filtered_sparxcc_data.tsv` is the original OTU table counts, after selecting only the OTUs used in the SparXCC analyses.
...
Compared to SparCC (that do take into account the compositional nature of sequencing data), SpiecEasi uses a graphical model to analyze directly correlated nodes (while SparCC does not account for populations indirectly correlated).

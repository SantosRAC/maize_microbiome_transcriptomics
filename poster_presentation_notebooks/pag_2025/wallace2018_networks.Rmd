...
### Computing centrality metrics for the main network
...
Computing Zi and Pi with functions from the [brainGraph R library](https://cran.r-project.org/web/packages/brainGraph/index.html):

...
merged_matrix_wallace2018_transposed <- t(merged_matrix_wallace2018)
# Using Meinshausen-Bühlman method (node wise regression model)
...
se.gl.wallace2018_merged <- spiec.easi(merged_matrix_wallace2018_transposed, method='glasso', lambda.min.ratio=1e-2, nlambda=20, pulsar.params=list(rep.num=50, ncores=4))
se.sparcc.wallace2018_merged <- sparcc(merged_matrix_wallace2018_transposed)
```

...
```{r}
wallace_cpm_otu_day <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/16S_wallace2018/combine_day_night_samples/summed_d_n_otu_day_cpm.tsv",
                                               row.names = "OTU.ID", header=TRUE)
wallace_cpm_otu_night <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/16S_wallace2018/combine_day_night_samples/summed_d_n_otu_night_cpm.tsv",
                                               row.names = "OTU.ID", header=TRUE)

kremling_tpm_expression_v5_day <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_day_tpm.tsv",
                                               row.names = "Name", header=TRUE)

kremling_tpm_expression_v5_night <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_night_tpm.tsv",
                                               row.names = "Name", header=TRUE)

kremling_rpkm_expression_v5_day <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_day_rpkm.tsv",
                                               row.names = "Name", header=TRUE)

kremling_rpkm_expression_v5_night <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_night_rpkm.tsv",
                                               row.names = "Name", header=TRUE)

kremling_cpm_expression_v5_day <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_day_cpm.tsv",
                                               row.names = "Name", header=TRUE)

kremling_cpm_expression_v5_night <- read.delim("/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_night_cpm.tsv",
                                               row.names = "Name", header=TRUE)

# Applying asinh transformation to gene expression data
kremling_raw_expression_v5_night_asinh <- asinh(kremling_raw_expression_v5_night)
kremling_raw_expression_v5_day_asinh <- asinh(kremling_raw_expression_v5_day)
kremling_tpm_expression_v5_day_asinh <- asinh(kremling_tpm_expression_v5_day)
kremling_tpm_expression_v5_night_asinh <- asinh(kremling_tpm_expression_v5_night)
kremling_rpkm_expression_v5_day_asinh <- asinh(kremling_rpkm_expression_v5_day)
kremling_rpkm_expression_v5_night_asinh <- asinh(kremling_rpkm_expression_v5_night)
kremling_cpm_expression_v5_day_asinh <- asinh(kremling_cpm_expression_v5_day)
kremling_cpm_expression_v5_night_asinh <- asinh(kremling_cpm_expression_v5_night)
norm_counts_tmm_day_asinh <- asinh(norm_counts_tmm_day)
norm_counts_tmm_night_asinh <- asinh(norm_counts_tmm_night)
uq_normalized_round_day_asinh <- asinh(uq_normalized_round_day)
uq_normalized_round_night_asinh <- asinh(uq_normalized_round_night)
ctf_normalized_day_asinh <- asinh(ctf_normalized_day)
ctf_normalized_night_asinh <- asinh(ctf_normalized_night)
cuf_normalized_day_asinh <- asinh(cuf_normalized_day)
cuf_normalized_night_asinh <- asinh(cuf_normalized_night)

# Applying asinh transformation to OTU data
wallace_cpm_otu_day_asinh <- asinh(wallace_cpm_otu_day)
wallace_cpm_otu_night_asinh <- asinh(wallace_cpm_otu_night)

# Writing transformed data to file
# I (RACS) had to make small changes in the output file to make columns match the identifiers (without X starting columns names and adding "Name" to column with genes); using vim :%s/^IX/^I/g (replace X with tab by tab)
write.table(kremling_raw_expression_v5_day_asinh, file = '/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_day_raw_asinh.tsv',
            sep = "\t", quote = FALSE)
write.table(kremling_raw_expression_v5_night_asinh, file = '/home/rsantos/Repositories/maize_microbiome_transcriptomics/rnaseq_kremling2018/quantification/kremling_expression_v5_night_raw_asinh.tsv',
            sep = "\t", quote = FALSE)
